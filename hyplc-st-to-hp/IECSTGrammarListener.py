...
class IECSTGrammarListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by IECSTGrammarParser#type_block.
    def enterType_block(self, ctx:IECSTGrammarParser.Type_blockContext):
        pass

    # Exit a parse tree produced by IECSTGrammarParser#type_block.
    def exitType_block(self, ctx:IECSTGrammarParser.Type_blockContext):
        pass
    ...
    # Enter a parse tree produced by IECSTGrammarParser#type_declaration.
    def enterType_declaration(self, ctx:IECSTGrammarParser.Type_declarationContext):
        pass

    # Exit a parse tree produced by IECSTGrammarParser#type_declaration.
    def exitType_declaration(self, ctx:IECSTGrammarParser.Type_declarationContext):
        pass
